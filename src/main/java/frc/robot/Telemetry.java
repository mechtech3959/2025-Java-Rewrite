...
public class Telemetry {
        ...
        public void telemeterize(SwerveDriveState state) {
                 ...
                 * state.ModuleStates[0].angle.getRadians(), null);
                 * builder.addDoubleProperty("Front Left Velocity",()->
                 * state.ModuleStates[0].speedMetersPerSecond, null);
                 * 
                 * builder.addDoubleProperty("Front Right Angle",()->
                 * state.ModuleStates[1].angle.getRadians(), null);
                 * builder.addDoubleProperty("Front Right Velocity",()->
                 * state.ModuleStates[1].speedMetersPerSecond, null);
                 * 
                 * builder.addDoubleProperty("Back Left Angle",()->
                 * state.ModuleStates[2].angle.getRadians(), null);
                 * builder.addDoubleProperty("Back Left Velocity",()->
                 * state.ModuleStates[2].speedMetersPerSecond, null);
                 * 
                 * builder.addDoubleProperty("Back Right Angle",()->
                 * state.ModuleStates[3].angle.getRadians(), null);
                 * builder.addDoubleProperty("Back Right Velocity",()->
                 * state.ModuleStates[3].speedMetersPerSecond, null);
                 * 
                 * builder.addDoubleProperty("Robot Angle",()-> state.RawHeading.getRadians(),
                 * null);
                 * }
                 * });
                 */
